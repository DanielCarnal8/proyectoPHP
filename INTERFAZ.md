...
<body>
    ...
    <div class="cuadro">
        ...
        <div class="semana">
                ...
                <select name="dia">
                    <option value="lunes"> Mon </option>
                    <option value="martes"> Tue </option>
                    <option value="miercoles"> Wed </option>
                    <option value="jueves"> Thu </option>
                    <option value="viernes"> Fri </option>
                    <option value="sabado"> Sat </option>
                    <option value="domingo"> Sun </option>
                </select>
                <br>
         </div>
